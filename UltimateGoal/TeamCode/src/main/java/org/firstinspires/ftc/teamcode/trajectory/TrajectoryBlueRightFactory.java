...
public class TrajectoryBlueRightFactory {
    ...
    private static List<TrajectoryWrapper> buildNone(AutoRobot robot, Pose2d startPose) {
        ...
        Trajectory toZone1 =
                drive.trajectoryBuilder(startPose, true)
                        .splineToSplineHeading(new Pose2d(15.0, 45, Math.toRadians(-90)), Math.toRadians(90))
                        .build();
        ...
        Trajectory toPickupSecondWobble =
                drive.trajectoryBuilder(forward1.end(), false)
                        ...
                        .lineToLinearHeading(new Pose2d(-35, 45, 0))
                        .build();
    ...
    private static List<TrajectoryWrapper> buildOne(AutoRobot robot, Pose2d startPose) {
        ...
        Trajectory toPickupSecondWobble =
                drive.trajectoryBuilder(forward1.end(), Math.toRadians(90.0))
                        .addDisplacementMarker(() -> robot.prepareArmToPickupWobbleGoal())
                        .splineToLinearHeading(new Pose2d(-35.0, 50.0, Math.toRadians(15)), Math.toRadians(-170))
                        .build();

        Trajectory turn1 =
                drive.trajectoryBuilder(toPickupSecondWobble.end(), Math.toRadians(40.0))
    ...
    private static List<TrajectoryWrapper> buildFour(AutoRobot robot, Pose2d startPose) {
        ...
        Trajectory toZone2 =
                drive.trajectoryBuilder(turn2.end(), true)
                        .lineToLinearHeading(new Pose2d(40, 60, Math.toRadians(-170)))
                        .build();
